...
public class TripApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public ClearParticipantByPartAndTripId clearParticipantByPartAndTripId(java.lang.Long partId, java.lang.Long tripId) throws java.io.IOException {
  ...
  public class ClearParticipantByPartAndTripId extends TripApiRequest<Void> {
     ...
     * @since 1.13
     */
    protected ClearParticipantByPartAndTripId(java.lang.Long partId, java.lang.Long tripId) {
    ...
    public ClearParticipantByPartAndTripId setPartId(java.lang.Long partId) {
      this.partId = partId;
      return this;
    }
   ...
   * @return the request
   */
  public GetParticipants getParticipants() throws java.io.IOException {
    GetParticipants result = new GetParticipants();
    initialize(result);
    return result;
  }
  ...
  public class GetParticipants extends TripApiRequest<com.cs407.onthedot.onthedotbackend.tripApi.model.ParticipantBeanCollection> {
    ...
    private static final String REST_PATH = "participantbeancollection";
